...
object KVUtils {
    ...
    fun setApiToken(value: String): Boolean = PhoneCredentialVault.put(KEY_API_TOKEN, value)
    ...
    fun setLumiLauncherId(value: String): Boolean =
        PhoneCredentialVault.put(KEY_LUMI_LAUNCHER_ID, value)
    ...
    fun setLumiLauncherSecret(value: String): Boolean =
        PhoneCredentialVault.put(KEY_LUMI_LAUNCHER_SECRET, value)
