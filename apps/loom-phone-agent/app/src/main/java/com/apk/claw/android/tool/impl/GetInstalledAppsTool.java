...
public class GetInstalledAppsTool extends BaseTool {
    ...
    public ToolResult execute(Map<String, Object> params) {
        ...
        try {
            ...
            Collections.sort(appList, (a, b) -> {
                int priority = Integer.compare(appPriority(a), appPriority(b));
    ...
    private int appPriority(String appLine) {
        String lower = appLine.toLowerCase(Locale.ROOT);
        if (lower.contains("| mark.via") || lower.startsWith("via |") || lower.contains("via browser")) {
            return 0;
        }
        return 1;
    }
