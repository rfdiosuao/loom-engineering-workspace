...
import com.apk.claw.android.channel.dingtalk.Android7DingTalkChannelHandler
...
object ChannelManager {
    ...
    fun init(
        ...
        handlers[Channel.DINGTALK] = if (BuildConfig.ANDROID7_COMPAT) {
            Android7DingTalkChannelHandler()
        } else {
