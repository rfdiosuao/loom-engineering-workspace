...
const SETTINGS_COPY: Record<AppLanguage, SettingsCopy> = {
  'zh-CN': {
    ...
    about: {
      appTitle: '应用',
      appDesc: `${APP_DISPLAY_NAME} 桌面端。`,
      name: '名称：',
      version: '版本：',
      positioning: '定位：',
      positioningValue: APP_DISPLAY_SUBTITLE,
      capabilitiesTitle: '开放能力',
      capabilitiesDesc: '桌面智能体、手机矩阵、共享模板与 Skill 在同一工作台协同。',
      capabilities: ['智能体安装', '手机矩阵', 'Skill 中心', '共享模板', '模型账号', '诊断'],
    },
    toast: {
  ...
  'en-US': {
    ...
    about: {
      appTitle: 'App',
      appDesc: `${APP_DISPLAY_NAME} desktop application.`,
      name: 'Name:',
      version: 'Version:',
      positioning: 'Role:',
      positioningValue: 'AI matrix customer acquisition workbench',
      capabilitiesTitle: 'Enabled Areas',
      capabilitiesDesc: 'Desktop agents, phone matrix, shared templates, and Skills work together in one workspace.',
      capabilities: ['Agent Installer', 'Phone Matrix', 'Skill Center', 'Shared Templates', 'Models', 'Diagnostics'],
    },
    toast: {
